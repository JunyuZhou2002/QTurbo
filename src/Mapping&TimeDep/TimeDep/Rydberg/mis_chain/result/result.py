...
custom_ticks = [10**-2, 10**0, 10**2, 10**4]
plt.yticks(custom_ticks, [r'$10^{-2}$', r'$10^{0}$', r'$10^{2}$', r'$10^{4}$'], fontsize=25)
...
for i in range(len(N_values[:len(array_base)])):
    array_base[i] = array_base[i]/(0.25 * (N_values[i]-1)+0.5*N_values[i]+0.25*(N_values[i]+0.75*N_values[i]+0.5*N_values[i]+0.25*N_values[i]))
for i in range(len(N_values[:len(array_opt)])):
    array_opt[i] = array_opt[i]/(0.25 * (N_values[i]-1)+0.5*N_values[i]+0.25*(N_values[i]+0.75*N_values[i]+0.5*N_values[i]+0.25*N_values[i]))
