...
import argparse
import pandas as pd
from simuq.systems.benchmark.pxp_array import GenQS
from simuq.solver import solve_aligned, generate_as
from simuq.aais.rydberg1d_global import generate_qmachine
...
parser.add_argument('--T', type=int, default=20, help='Specify the evolution time T')
