...
from AQS.system.pxp_array import *
from AQS.simulator.rydberg1D_global import *
...
parser.add_argument('--N', type=int, default=6, help='Specify the system size N')
parser.add_argument('--J', type=float, default=0.05, help='Specify the interaction strength J')
parser.add_argument('--h', type=float, default=0.02, help='Specify the interaction strength h')
parser.add_argument('--T', type=int, default=1, help='Specify the evolution time T')
parser.add_argument('--F', type=str, default="opt.csv", help='Specify the file name to put result')
