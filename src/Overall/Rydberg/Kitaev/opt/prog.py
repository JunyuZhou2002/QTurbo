...
parser.add_argument('--M', type=float, default=1.0, help='Specify the interaction strength J')
parser.add_argument('--t', type=float, default=1.0, help='Specify the interaction strength J')
...
# Hamiltonian of Kitaev
model = kitaev(N, miu, t, h, T)

# Rydberg2D machine
machine = gen_rydberg1D(N)
init_fun = init_gen(miu/2, T, N)
...
columns = ["Size N / miu / t / h / Evol T", " Compilation Time", " Execution Time", " Error", " solution"]  
